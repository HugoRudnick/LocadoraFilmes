...
import * as actions from '../Actions/filmes'
import * as actionsGenero from '../Actions/generos'
                            ...
                            <MenuItem value="Inativo">Inativo</MenuItem> */}
{
                        props.generoList.map((record, index) => {
                            return (
                                <MenuItem value= { record.idGenero } >  { record.nome }   </MenuItem>   
                            )
                        })
}
                        </Select>
